...
//            return;
//        }
//        System.out.println("mobileNumberAttribute = " + mobileNumberAttribute);
//        String mobileNumber = OTPAuthenticatorUtil.getAttributeValue(context.getUser(), mobileNumberAttribute);
//
//        if (mobileNumber != null && !mobileNumber.isEmpty()) {
//            long nrOfDigits = OTPAuthenticatorUtil.getConfigLong(config, OTPAuthenticatorContstants.CONF_PRP_SMS_CODE_LENGTH, 4L);
...
//                Response challenge = context.form().createForm("login-bimany.ftl");
